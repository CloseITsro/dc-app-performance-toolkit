We cloned this repo for internal purpose only. Added some tests for testing DC version of our [Subtasks Navigation for Jira](https://atlas.closeit.co/subtasks-navigation-for-jira) app.
